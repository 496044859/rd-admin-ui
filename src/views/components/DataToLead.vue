          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="目标表">
                <el-input disabled size="small" placeholder="文件层" v-if="dialogVisible.excelDeriveIsShow=== false"></el-input>
                <el-input disabled size="small" placeholder="案卷层" v-else-if="dialogVisible.excelDeriveIsShow=== true"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <!-- <el-row>
...
export default {
  ...
  methods: {
    ...
    cleraList () {
      ...
      this.dialogVisible.excelDeriveIsShow = false
      this.dialogVisible.excelDataAjid = false
    },
    getArchiveNo () {
      const params = {
        dalxid: this.config.dalxid,
    ...
    handleImportExcel () {
      ...
      if (this.dialogVisible.excelDataAjid) {
        ImportData.ajid = this.listQuery.ajid
      }
