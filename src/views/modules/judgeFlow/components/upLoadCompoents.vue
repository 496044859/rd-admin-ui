<template>
  <section>
    <el-dialog title="请上传档案鉴定报告" :visible.sync="dialogVisible.dialogUpVisible" width="50%" @close="handleClose" :close-on-click-modal="false">
      <el-upload
        ref="upload"
        class="upload-demo"
        :file-list="fileList"
...
export default {
  ...
  data () {
    return {
      uploadUrl: process.env.BASE_API + '/uploadAttachments@JudgeAction.action',
      uploadNumberMax: 1,
      fileList: [],
      progressing: 0
    }
