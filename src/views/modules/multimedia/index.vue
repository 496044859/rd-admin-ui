      ...
      <section v-show="config.dasid !== ''">
        ...
        <div class="table-list">
          <el-table :data="attachList" @selection-change="handleSelectionChange" v-loading.body="listLoading" highlight-current-row stripe style="width: 100%">
            ...
            <el-table-column prop="wjmc" label="挂接包名称" sortable></el-table-column>
            <el-table-column prop="gjsj" label="挂接时间" sortable></el-table-column>
            <el-table-column prop="drzt" label="状态" sortable></el-table-column>
            <el-table-column prop="gjjg" label="挂接结果" sortable></el-table-column>
            <!--<el-table-column prop="cfsjclfs" label="处理方式" sortable>
              <template slot-scope="scope">
                <span>{{scope.row.cfsjclfs | typeFilter}}</span>
              </template>
            </el-table-column>-->
          </el-table>
        </div>
